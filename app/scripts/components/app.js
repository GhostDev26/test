        ...
        <div className='routeHandler route-header'>
          <div className="btn-group">
            ...
            <ul className='dropdown-menu' role='menu'>
              ...
              <li>
                <Link to='browsecollections'>browse collections</Link>
              </li>
              <li>
              ...
              <li>
                <Link to='parallaxpage'>Parallax</Link>
              </li>
              <li>
                <Link to='paddedunderline'>PaddedUnderline</Link>
              </li>
              <li>
                <Link to='photocollections'>PhotoCollections</Link>
              </li>
              <li>
