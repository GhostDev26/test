              ...
              aria-labelledby='registerModal' aria-hidden='true'>
                <div className='modal-dialog'>
                  <div className='modal-content'>
                    <div className='modal-header'>
                      <button type='button' className='close' data-dismiss='modal' aria-hiddden='true'>x</button>
                      <h4 className='register-title' id='registerLabel'>WELCOME TO ARTFACTUM</h4>
                    </div>
                    <div className='modal-body'>
                      <h6>Alread have an Artfactum account?</h6>
                      <button class="facebook-connect" onClick={this.handleFacebookLogin}>Quick sign-up using Facebook</button>
                    </div>
                    <div className='modal-footer'>
                      <button type='button' className='btn btn-default' data-dismiss='modal' >Close</button>
                      <button type='button' className='btn btn-primary'>Save Changes</button>
              ...
              <div className="parallax">
                <div id='first-page' className='parallax__group'>
                  <div className="parallax__layer parallax__layer--back">
                    ...
                    <p>
                      <p className='oval-button'>
                        <span>Launch Your Own Gallery</span>
                      </p>
                      <p className='second-oval oval-button'>
                        <span>Discover</span>
                      </p>
                    </p>
